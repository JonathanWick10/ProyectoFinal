...
public class PetsChildFragment extends Fragment {
    ...
    @BindView(R.id.layout_description_pets)
    LinearLayout layout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pets_child, container, false);
    ...
    private void initRecycler() {
        ...
        collectionReferenceMemorizame.document(user.getUid()).collection("Pets").get()
