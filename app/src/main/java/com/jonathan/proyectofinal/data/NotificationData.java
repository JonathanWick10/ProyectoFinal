...
public class NotificationData {
    ...
    public NotificationData(String idNotification, int startHour, int startMinute, long startTime, long frequency, long unitOfTime, Uri tone, String titleNotification, String messageNotification, Boolean status, String patientId, int type) {
